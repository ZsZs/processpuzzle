...
exports.createBaseDocumentRouter = createBaseDocumentRouter;
exports.createBaseDocumentApp = createBaseDocumentApp;
const express_1 = __importStar(require("express"));
const cors_1 = __importDefault(require("cors"));
const firebase_functions_1 = require("firebase-functions");
const https_1 = require("firebase-functions/https");
const base_document_config_js_1 = require("./base-document.config.js");
const base_document_handlers_js_1 = require("./base-document.handlers.js");
/**
...
function createBaseDocumentRouter(handlers = new base_document_handlers_js_1.BaseDocumentHandlers()) {
...
function createBaseDocumentApp(handlers) {
    const app = (0, express_1.default)();
    app.use((0, cors_1.default)({ origin: true, allowedHeaders: ALLOWED_HEADERS }));
    ...
    app.use(base_document_config_js_1.API_BASE_PATH, router);
    app.use('/', router);
    app.use((error, _request, response, next) => {
        firebase_functions_1.logger.error('Base document request failed', error);
...
function isBodyParseFailure(error) {
 ...
 */
exports.baseDocument = (0, https_1.onRequest)({ region: 'europe-central2', memory: '512MiB', timeoutSeconds: 120, invoker: 'public' }, createBaseDocumentApp());
//# sourceMappingURL=base-document.function.js.map