/**
 * The wire shape of a running instance of `order-fulfillment-workflow`, as
 * `GET /organizations/{orgKey}/instances/{instanceId}` answers it in base-workflow-api.yaml.
 *
...
export const OTHER_WORKFLOW_INSTANCE_DTO = {
...
export function pageOfWorkflowInstances(...content: object[]) {
