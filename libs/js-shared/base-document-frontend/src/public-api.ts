...
export { Document, DocumentInputPort, DocumentOutputPort, AttributeVisibilityMode, BlockKind, PortType, WidgetPlacement } from './lib/domain/base-document';
export type { AttributeVisibility, DocumentBlock } from './lib/domain/base-document';
