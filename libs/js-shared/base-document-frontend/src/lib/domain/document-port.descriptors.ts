...
function createDocumentInputPortAttrDescriptors(): AbstractAttrDescriptor[] {
...
function createDocumentOutputPortAttrDescriptors(): AbstractAttrDescriptor[] {
  const [nameAttr, typeAttr, descriptionAttr, entityTypeAttr, attributeVisibilityAttr] = createCommonPortAttrs();
...
export function createDocumentInputPortDescriptor(): BaseEntityDescriptor {
...
export function createDocumentOutputPortDescriptor(): BaseEntityDescriptor {
  return new BaseEntityDescriptor({
