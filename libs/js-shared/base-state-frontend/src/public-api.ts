...
export { BeanRef, State, StateMachineDefinition, Transition, type PropertyMap } from './lib/domain/definition/state-machine-definition';
...
} from './lib/domain/definition/state-entity-names';
export { createStateMachineDefinitionDescriptor } from './lib/domain/definition/state-machine-definition.descriptors';
export { STATE_MACHINE_STATE_ID_FIELD, createStateDescriptor } from './lib/domain/definition/state.descriptors';
export { STATE_MACHINE_TRANSITION_ID_FIELD, createTransitionDescriptor } from './lib/domain/definition/transition.descriptors';
export { BEAN_REF_ID_FIELD, createActionRefDescriptor, createGuardRefDescriptor } from './lib/domain/definition/bean-ref.descriptors';
export { StateMachineDefinitionMapper } from './lib/domain/definition/state-machine-definition.mapper';
export { StateMachineDefinitionService } from './lib/domain/definition/state-machine-definition.service';
export { StateMachineDefinitionStore } from './lib/domain/definition/state-machine-definition.store';
...
export {
  StateMachineStateFacade,
  StateMachineTransitionFacade,
  StateTransitionActionFacade,
  StateTransitionGuardFacade,
} from './lib/feature/definition/state-machine-embedded.facades';
