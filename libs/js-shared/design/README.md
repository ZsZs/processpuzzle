...
It sits alongside the corresponding runtime libraries (`base-entity`, `base-rule-frontend`, `base-state-frontend`, `base-desktop-frontend`, `base-process-frontend`) and composes their routes into a single design experience.
