...
/**
 * Thrown by {@code DeleteArtifactBlock} when the block being removed is a REFERENCED widget
 ...
 */
public class ArtifactBlockReferencedException extends RuntimeException {

    private final List<String> referencingBlockIds;

    public ArtifactBlockReferencedException(String blockId, List<String> referencingBlockIds) {
