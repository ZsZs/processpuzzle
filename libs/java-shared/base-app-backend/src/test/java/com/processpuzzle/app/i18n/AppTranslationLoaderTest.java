...
class AppTranslationLoaderTest {
    ...
    void mergesIntoABundleThatIsAlreadyThere() {
        AppTranslationBundle existing =
                new AppTranslationBundle(ORG, "a_scope", "en", Map.of("kept", "old", "shared", "old"));
    ...
    void namesItselfToTheImporterSoTheStartupLogCanTellTheSevenApart() {
        ...
        verify(importer).importAll(org.mockito.ArgumentMatchers.eq("base-app"), any());
    }
}
