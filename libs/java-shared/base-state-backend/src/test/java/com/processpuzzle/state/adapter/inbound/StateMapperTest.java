...
class StateMapperTest {
    ...
    void toDomain_and_applyToDomain_shouldMapCorrectly() {
        ...
        com.processpuzzle.state.model.GuardRef modelGuard =
                new com.processpuzzle.state.model.GuardRef("guardBean").params(Map.of("p1", "v1"));
        com.processpuzzle.state.model.ActionRef modelAction =
                new com.processpuzzle.state.model.ActionRef("actionBean").params(Map.of("a1", "v2"));

        com.processpuzzle.state.model.Transition modelTransition =
                new com.processpuzzle.state.model.Transition("submit", "draft", "submitted", "SUBMIT")
    ...
    void toDomain_nullStatesAndTransitions_shouldMapEmptyLists() {
        ...
        com.processpuzzle.state.model.Transition transitionWithNulls =
                new com.processpuzzle.state.model.Transition("submit", "draft", "submitted", "SUBMIT")
                        .guards(null)
                        .actions(null);
    ...
    void toModel_fromStateMachineDefinition_shouldMapCorrectly() {
        ...
        com.processpuzzle.state.model.StateMachineDefinition model = mapper.toModel(definition);
