...
class StateTranslationLoaderTest {
    ...
    void storesABundleThatIsNotThereYet() {
        ...
        ArgumentCaptor<StateTranslationBundle> saved = ArgumentCaptor.forClass(StateTranslationBundle.class);
    ...
    void mergesIntoABundleThatIsAlreadyThere() {
        StateTranslationBundle existing =
                new StateTranslationBundle(ORG, "a_scope", "en", Map.of("kept", "old", "shared", "old"));
    ...
    void namesItselfToTheImporterSoTheStartupLogCanTellTheSevenApart() {
        ...
        verify(importer).importAll(org.mockito.ArgumentMatchers.eq("base-state"), any());
    }
}
