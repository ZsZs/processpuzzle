...
public class StateMachineEngine {
     ...
     *
     * @throws com.processpuzzle.state.usecase.exception.UnknownTriggerException if {@code
    ...
    public TransitionOutcome fire(StateMachineDefinition definition, UUID objectId,
        ...
        if (!triggerExistsAnywhere) {
            throw new com.processpuzzle.state.usecase.exception.UnknownTriggerException(definition.getEntityName(), triggerKey);
        }
