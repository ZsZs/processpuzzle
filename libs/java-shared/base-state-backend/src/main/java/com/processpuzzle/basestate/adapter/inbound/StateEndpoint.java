...
import com.processpuzzle.basestate.api.BaseStateApi;
...
public class StateEndpoint implements BaseStateApi {
    ...
    @Override
    public ResponseEntity<com.processpuzzle.basestate.model.StateMachineDefinition> getStateMachineDefinition(
