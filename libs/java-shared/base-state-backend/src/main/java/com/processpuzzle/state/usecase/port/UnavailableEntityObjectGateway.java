 ...
 * com.processpuzzle.state.usecase.service.EntityObjectGatewayResolver}, so a real gateway bean
...
public class UnavailableEntityObjectGateway implements EntityObjectGateway {
    ...
    private static final String MESSAGE =
            "No EntityObjectGateway bean is configured. base-state-backend cannot read or write "
                    ...
                    + "adapter) implements com.processpuzzle.state.usecase.port.EntityObjectGateway "
