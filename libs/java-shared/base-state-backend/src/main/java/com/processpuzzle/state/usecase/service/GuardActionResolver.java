...
/**
 * Resolves {@link com.processpuzzle.state.domain.GuardRef#beanName()} and {@link
 * com.processpuzzle.state.domain.ActionRef#beanName()} against the Spring context, by name —
