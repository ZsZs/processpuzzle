...
public class StateMapper {
    ...
    public com.processpuzzle.basestate.model.StateMachineDefinition toModel(StateMachineDefinition definition) {
        com.processpuzzle.basestate.model.StateMachineDefinition model =
                new com.processpuzzle.basestate.model.StateMachineDefinition(
    ...
    public PageOfStateMachineDefinition toModel(Page<StateMachineDefinition> page) {
        List<com.processpuzzle.basestate.model.StateMachineDefinition> content =
    ...
    private List<State> toDomainStates(List<com.processpuzzle.basestate.model.State> states) {
        if (states == null) {
            return List.of();
        }
    ...
    private State toDomainState(com.processpuzzle.basestate.model.State s) {
        return new State(
    ...
    private List<Transition> toDomainTransitions(List<com.processpuzzle.basestate.model.Transition> transitions) {
        if (transitions == null) {
            return List.of();
        }
    ...
    private Transition toDomainTransition(com.processpuzzle.basestate.model.Transition t) {
    ...
    private List<com.processpuzzle.basestate.model.State> toModelStates(List<State> states) {
        return states.stream().map(s -> new com.processpuzzle.basestate.model.State(s.key(), s.name())
    ...
    private List<com.processpuzzle.basestate.model.Transition> toModelTransitions(List<Transition> transitions) {
        return transitions.stream().map(t -> new com.processpuzzle.basestate.model.Transition(
                        t.key(), t.sourceStateKey(), t.targetStateKey(), t.triggerKey())
                .name(t.name())
                .guards(t.guards().stream()
                        .map(g -> new com.processpuzzle.basestate.model.GuardRef(g.beanName()).params(g.params()))
                        .toList())
                .actions(t.actions().stream()
                        .map(a -> new com.processpuzzle.basestate.model.ActionRef(a.beanName()).params(a.params()))
                        .toList())
        ).toList();
    }
