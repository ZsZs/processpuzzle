...
public class WidgetTranslationBundle extends AbstractTranslationBundle {

    protected WidgetTranslationBundle() {
        // required by JPA
    }

    public WidgetTranslationBundle(String orgKey, String scope, String locale, Map<String, Object> messages) {
