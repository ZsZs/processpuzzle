...
public class WidgetTranslationEndpoint implements BaseWidgetTranslationsApi {
    ...
    public ResponseEntity<Map<String, Object>> getWidgetTranslations(String orgKey, String locale) {
        return bundle(orgKey, AbstractTranslationBundle.ROOT_SCOPE, locale);
    }

    @Override
    @Transactional(readOnly = true)
    public ResponseEntity<Map<String, Object>> getWidgetScopedTranslations(String orgKey, String scope, String locale) {
