 ...
 */
@Entity
@Table(name = "document_ui_translations")
public class DocumentUiTranslationBundle extends AbstractTranslationBundle {

    protected DocumentUiTranslationBundle() {
        // required by JPA
    }

    public DocumentUiTranslationBundle(String orgKey, String scope, String locale, Map<String, Object> messages) {
