...
class EntityTranslationLoaderTest {
    ...
    void storesABundleThatIsNotThereYet() {
        ...
        ArgumentCaptor<EntityTranslationBundle> saved = ArgumentCaptor.forClass(EntityTranslationBundle.class);
    ...
    void mergesIntoABundleThatIsAlreadyThere() {
        EntityTranslationBundle existing =
                new EntityTranslationBundle(ORG, "a_scope", "en", Map.of("kept", "old", "shared", "old"));
    ...
    void namesItselfToTheImporterSoTheStartupLogCanTellTheSevenApart() {
        ...
        verify(importer).importAll(org.mockito.ArgumentMatchers.eq("base-entity"), any());
    }
}
