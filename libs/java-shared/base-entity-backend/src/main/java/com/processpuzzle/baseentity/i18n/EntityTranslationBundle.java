 ...
 */
@Entity
@Table(name = "base_entity_translations")
public class EntityTranslationBundle extends AbstractTranslationBundle {

    protected EntityTranslationBundle() {
        // required by JPA
    }

    public EntityTranslationBundle(String orgKey, String scope, String locale, Map<String, Object> messages) {
