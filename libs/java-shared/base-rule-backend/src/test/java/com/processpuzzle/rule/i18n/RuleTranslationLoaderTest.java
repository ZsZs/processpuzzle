...
class RuleTranslationLoaderTest {
    ...
    void storesABundleThatIsNotThereYet() {
        ...
        ArgumentCaptor<RuleTranslationBundle> saved = ArgumentCaptor.forClass(RuleTranslationBundle.class);
    ...
    void mergesIntoABundleThatIsAlreadyThere() {
        RuleTranslationBundle existing =
                new RuleTranslationBundle(ORG, "a_scope", "en", Map.of("kept", "old", "shared", "old"));
    ...
    void namesItselfToTheImporterSoTheStartupLogCanTellTheSevenApart() {
        ...
        verify(importer).importAll(org.mockito.ArgumentMatchers.eq("base-rule"), any());
    }
}
