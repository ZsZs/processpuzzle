...
public class RuleTranslationBundle extends AbstractTranslationBundle {

    protected RuleTranslationBundle() {
        // required by JPA
    }

    public RuleTranslationBundle(String orgKey, String scope, String locale, Map<String, Object> messages) {
