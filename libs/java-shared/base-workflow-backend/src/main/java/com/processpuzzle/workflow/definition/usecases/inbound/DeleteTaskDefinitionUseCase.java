...
/**
 * Refuses to remove a task any workflow still assigns. One guard suffices here: nothing but a workflow
...
public class DeleteTaskDefinitionUseCase {
    ...
    public void delete(String orgKey, String id) {
        ...
        List<String> workflows = referenceScanner.workflowsAssigningTask(orgKey, id);
