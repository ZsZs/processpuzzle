...
public class WorkflowExecutionMapper {
    ...
    public com.processpuzzle.workflow.model.ProcessInstance toModel(ProcessInstance instance, List<TaskInstance> tasks,
        ...
        model.setContext(ProcessContext.assemble(instance, tasks));
     ...
     * this mapper has no repository to reach — see {@code ProcessInstancesEndpoint.listProcessInstances}.
     *
     ...
     */
    public PageOfProcessInstance toPageModel(Page<ProcessInstance> page,
                                              List<com.processpuzzle.workflow.model.ProcessInstance> content) {
        return new PageOfProcessInstance()
                .content(content)
