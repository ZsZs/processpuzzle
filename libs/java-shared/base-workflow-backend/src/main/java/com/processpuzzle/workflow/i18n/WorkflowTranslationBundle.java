 ...
 */
@Entity
@Table(name = "workflow_translations")
public class WorkflowTranslationBundle extends AbstractTranslationBundle {

    protected WorkflowTranslationBundle() {
        // required by JPA
    }

    public WorkflowTranslationBundle(String orgKey, String scope, String locale, Map<String, Object> messages) {
