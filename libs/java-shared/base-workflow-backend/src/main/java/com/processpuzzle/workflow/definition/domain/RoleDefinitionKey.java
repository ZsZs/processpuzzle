...
/**
 * Composite primary key of {@link RoleDefinition}: a role id is unique only within its organization, so two tenants may
 ...
 */
public class RoleDefinitionKey implements Serializable {
    ...
    public RoleDefinitionKey() {
        // required by JPA
    }

    public RoleDefinitionKey(String orgKey, String id) {
        this.orgKey = orgKey;
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RoleDefinitionKey that)) {
            return false;
        }
