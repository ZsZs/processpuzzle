...
/**
 * Runtime tracking row for one {@code WorkProductDefinition} within a {@link ProcessInstance}.
...
@ToString
@Entity
@Table(name = "workflow_work_product_instance")
public class WorkProductInstance {
    ...
    @Column(nullable = false)
    private String workProductDefinitionId;
