...
/**
 * Composite primary key of {@link TaskDefinition}: a task id is unique only within its organization, so two tenants may
 ...
 */
public class TaskDefinitionKey implements Serializable {
    ...
    public TaskDefinitionKey(String orgKey, String id) {
        this.orgKey = orgKey;
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TaskDefinitionKey that)) {
            return false;
        }
