...
@Component({
  selector: 'base-artifacts-overview',
  standalone: true,
  ...
  template: `
    <ng-container *transloco="let t; prefix: 'base-artifacts'">
      <section class="intro">
        ...
        <ul>
          <li><strong>&#64;processpuzzle/base-artifact</strong> — {{ t('intro_frontend_desc') }}</li>
          <li><strong>base-artifact-backend</strong> — {{ t('intro_backend_desc') }}</li>
        </ul>
      ...
      <section>
        ...
        <markdown clipboard mermaid ngPreserveWhitespaces [src]="'https://raw.githubusercontent.com/ZsZs/processpuzzle/refs/heads/develop/libs/js-shared/base-artifact-frontend/README.md'"></markdown>
      </section>

      <section>
        <h2>{{ t('backend_heading') }}</h2>
        <markdown clipboard mermaid ngPreserveWhitespaces [src]="'https://raw.githubusercontent.com/ZsZs/processpuzzle/refs/heads/develop/libs/java-shared/base-artifact-backend/README.md'"></markdown>
      </section>
    </ng-container>
  `,
  styles: `
