  ...
  template: `
    <ng-container *transloco="let t; prefix: 'base-apps'">
      <section class="intro">
        ...
        <ul>
          <li><strong>&#64;processpuzzle/base-app</strong> — {{ t('intro_frontend_desc') }}</li>
          <li><strong>base-app-backend</strong> — {{ t('intro_backend_desc') }}</li>
        </ul>
      ...
      <section>
        ...
        <markdown clipboard mermaid ngPreserveWhitespaces [src]="'https://raw.githubusercontent.com/ZsZs/processpuzzle/refs/heads/develop/libs/js-shared/base-app-frontend/README.md'"></markdown>
      </section>

      <section>
        <h2>{{ t('backend_heading') }}</h2>
        <markdown clipboard mermaid ngPreserveWhitespaces [src]="'https://raw.githubusercontent.com/ZsZs/processpuzzle/refs/heads/develop/libs/java-shared/base-app-backend/README.md'"></markdown>
      </section>
    </ng-container>
  `,
  styles: `
