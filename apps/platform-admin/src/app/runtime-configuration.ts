 ...
 *
 * Identical to the testbed's, minus nothing — the four sections are what `ConfigurationService`
 * merges and what `createAppConfig` reads. It extends the section interfaces as well as naming them
 * as properties because that is the contract `ConfigurationService` was written against.
 */
